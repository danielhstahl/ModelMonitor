...
class StateSpaceXploration(object):
    ...
    def generateDataSet(self, sparkSession, numSims:int, columns:List[Tuple[str, str, List[Any]]]):
        ...
        return DataFrame(
            self._java_obj.generateDataSet(
                ...
                numSims, _jColNameTypeArray
            ), 
            sparkSession._instantiatedSession
        )

    def getPredictions(
        self, sparkSession, simulatedDataSet, 
        fittedPipeline, featuresCol="features", predictionCol="prediction"
    ):
        return DataFrame(self._java_obj.getPredictions(
            simulatedDataSet._jdf, fittedPipeline._to_java(), 
