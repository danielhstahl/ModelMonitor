...
def create_test_dataset(spark):
    ...
    dataset = pd.DataFrame(
        data={
            "v1": ["text1", "text2", "text3", "text2", "text2", "text1"],
            "v2": ["val1", "val2", "val1", "val1", "val2", "val1"],
...
class TestEndToEndIntegration:
    ...
    def test_end_to_end_integration(self):
        ...
        cdf.saveDistribution(
            self.train_dataset, columnNameAndTypeArray, "./test_py.json"
        )
        results = cdf.getNewDistributionsAndCompare(
            self.test_dataset, columnNameAndTypeArray, "./test_py.json"
        )
